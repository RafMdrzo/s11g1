                    ...
                    for(i = 0; i < result.length; i++)
                    {
                      if(result[i].user == req.session.username)
                      {
                        ...
                        var postMirror = {
                          ...
                          post_elapsed: elapsed > 24 ? (Math.floor(elapsed/24) > 1 ? (Math.floor(elapsed/24) + ' days ago') : '1 day ago') : (elapsed > 1 ? (Math.floor(elapsed) + ' hours ago') : (Math.floor(elapsed*60) <= 1 ? '1 minute ago' : (Math.floor(elapsed*60) + ' minutes ago'))),
